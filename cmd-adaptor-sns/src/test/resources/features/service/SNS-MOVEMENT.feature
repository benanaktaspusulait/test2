@serviceMovement
Feature: SNS Command Adaptor - Service - SNS-MOVEMENT
  ...
  Background:
    Given template StreamIngestRecord source data with the following attributes
      ...
      | body.goods.goodsItems.0.containers.1.containerNumber                  | goods.goodsItems.0.containers.1.containerNumber                  |
  ...
  Scenario: ServiceRecord - SNS-MOVEMENT
    ...
    And one Service record for "SNS-MOVEMENT" with following attributes
      ...
      | metadata.sourceRecord.id                                                | {movementReferenceNumber}                                                                                     |
      ...
      | dueTimestamp                                                            | null                                                                                                          |
      | status                                                                  | null                                                                                                          |
      | movement.businessIdentifier                                             | movementReferenceNumber                                                                                       |
      | movement.source                                                         | metadata.senderEORI                                                                                           |
      | movement.mode                                                           | Rail                                                                                                          |
      ...
      | attributes.attrs.goods.grossMass                                        | 11.1                                                                                                          |
      ...
      | attributes.attrs.metadata.senderEORI                                    | metadata.senderEORI                                                                                           |
