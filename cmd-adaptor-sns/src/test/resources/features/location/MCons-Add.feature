@locationMConsAdd
Feature: SNS Command Adaptor - Location - SNS-M-CONS-ADD
  ...
  Scenario: LocationRecord - SNS-M-CONS-ADD
    When StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 1 Location Commands for SNS-M-CONS-ADD will be emitted
    And one Location record for "SNS-M-CONS-ADD" with following attributes
      | metadata.identityRecord.poleId.v2.id          | SNSENS:P={partiesConsigneeName23ParisPA12 IS200}[SNS-M-CONSIGNEE],L={23ParisPA12 IS200} |
      ...
      | endTimestamp                                  | null                                                                                    |
      | type                                          | ADDRESS                                                                                 |
      | party.poleId.v2.id                            | SNSENS:P={partiesConsigneeName23ParisPA12 IS200}[SNS-M-CONSIGNEE]                       |
      | party.type                                    | P                                                                                       |
      | role                                          | PTOLCSIGNE                                                                              |
      | address.type                                  | LOCADDR                                                                                 |
      | address.postCode                              | PA12 IS                                                                                 |
      | address.poBox                                 | null                                                                                    |
      | address.fullAddress                           | partiesConsigneeName 23 Paris PA12 IS 200                                               |
      | address.name                                  | partiesConsigneeName                                                                    |
  ...
  Scenario: STOP: SNS-M-CONS-ADD not created if name and eori are null
    ...
    Then 0 Location Commands for SNS-M-CONS-ADD will be emitted
