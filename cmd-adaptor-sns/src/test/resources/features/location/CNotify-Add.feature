@locationCNotifyAdd
Feature: SNS Command Adaptor - Location - SNS-C-NOTIFY-ADD
  ...
  Scenario: LocationRecord - SNS-C-NOTIFY-ADD
  ...
  Scenario: STOP: SNS-C-NOTIFY-ADD not created if name and eori are null
    ...
    Then 0 Location Commands for SNS-C-NOTIFY-ADD will be emitted
