@locationSnsSenderAdd
Feature: Test sns Command Adaptor - Location - SNS-SENDER-ADD
...
# This logic needs updating in customEORILookupNull in future
  Background:
    Given template StreamIngestRecord source data with the following attributes
      ...
      | body.metadata.senderEORI                                              | EORI123                                                          |
  ...
  Scenario: LocationRecord - SNS-SENDER-ADD
    ...
    And one Location record for "SNS-SENDER-ADD" with following attributes
      ...
      | metadata.sourceRecord.id                      | {EORI123}                                  |
      ...
      | type                                          | ADDRESS                                    |
      | party.poleId.v2.id                            | SNSENS:P={EORI123}[SNS-SENDER]             |
      | party.type                                    | P                                          |
      | role                                          | PTOLASSO                                   |
      | startTimestamp                                | null                                       |
      | endTimestamp                                  | null                                       |
      | address.type                                  | LOCADDR                                    |
      | address.postCode                              | EORI123                                    |
      | address.poBox                                 | null                                       |
      | address.fullAddress                           | EORI123                                    |
      | address.name                                  | EORI123                                    |
      | address.siteLocation                          | null                                       |
      | address.number                                | null                                       |
      | address.street                                | EORI123                                    |
      | address.town                                  | EORI123                                    |
      | address.area                                  | null                                       |
