@locationMNotifyAdd
Feature: SNS Command Adaptor - Location - SNS-M-NOTIFY-ADD
  ...
  Scenario: LocationRecord - SNS-M-NOTIFY-ADD
    When StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 1 Location Commands for SNS-M-NOTIFY-ADD will be emitted
    And one Location record for "SNS-M-NOTIFY-ADD" with following attributes
      | metadata.identityRecord.poleId.v2.id          | SNSENS:P={partiesNotifyName56BristolBR00 6OL100}[SNS-M-NOTIFY],L={56BristolBR00 6OL100} |
      ...
      | party.poleId.v2.id                            | SNSENS:P={partiesNotifyName56BristolBR00 6OL100}[SNS-M-NOTIFY]                          |
      | party.type                                    | P                                                                                       |
      | role                                          | PTOLASSO                                                                                |
      | address.type                                  | LOCADDR                                                                                 |
      | address.postCode                              | BR00 6OL                                                                                |
      | address.poBox                                 | null                                                                                    |
      | address.fullAddress                           | partiesNotifyName 56 Bristol BR00 6OL 100                                               |
      | address.name                                  | partiesNotifyName                                                                       |
  ...
  Scenario: STOP: SNS-M-NOTIFY-ADD not created if name and eori are null
    ...
    Then 0 Location Commands for SNS-M-NOTIFY-ADD will be emitted
