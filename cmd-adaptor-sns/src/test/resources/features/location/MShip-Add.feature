@locationMShipAdd
Feature: SNS Command Adaptor - Location - SNS-M-SHIP-ADD
  ...
  Scenario: LocationRecord - SNS-M-SHIP-ADD
    When StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 1 Location Commands for SNS-M-SHIP-ADD will be emitted
    And one Location record for "SNS-M-SHIP-ADD" with following attributes
      | metadata.identityRecord.poleId.v2.id          | SNSENS:P={partiesConsignorName90CardiffCA34 7FF100}[SNS-M-SHIPPER],L={90CardiffCA34 7FF100} |
      ...
      | type                                          | ADDRESS                                                                                     |
      | party.poleId.v2.id                            | SNSENS:P={partiesConsignorName90CardiffCA34 7FF100}[SNS-M-SHIPPER]                          |
      | party.type                                    | P                                                                                           |
      | role                                          | PTOLSHIP                                                                                    |
      | address.type                                  | LOCADDR                                                                                     |
      | address.postCode                              | CA34 7FF                                                                                    |
      | address.poBox                                 | null                                                                                        |
      | address.fullAddress                           | partiesConsignorName 90 Cardiff CA34 7FF 100                                                |
      | address.name                                  | partiesConsignorName                                                                        |
  ...
  Scenario: STOP: SNS-M-SHIP-ADD not created if name and eori are null
    ...
    Then 0 Location Commands for SNS-M-SHIP-ADD will be emitted
