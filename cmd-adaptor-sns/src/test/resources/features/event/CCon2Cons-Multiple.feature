@EventSnsCCon2ConMultiple
Feature: Test sns Command Adaptor - Event - Association Start - SSNS-ASSOC-CCon2Cons - Multiple
  ...
  Scenario: EventRecord - AssociationStart - SSNS-ASSOC-CCon2Cons - Multiple
    When StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 2 Event Commands for SNS-ASSOC-CCon2Cons will be emitted
    And one Event record for "SNS-ASSOC-CCon2Cons" with following attributes
      | metadata.identityRecord.poleId.v2.id          | SNSENS:E={[SNSENS:P={goodsConsigneeName15LondonLD12 3ON100}[SNS-C-CONSIGNEE]][SNSENS:S={movementReferenceNumber123}][PTOSCSIGNE]} |
      ...
      | metadata.sourceRecord.id                      | {[SNSENS:P={goodsConsigneeName15LondonLD12 3ON100}[SNS-C-CONSIGNEE]][SNSENS:S={movementReferenceNumber123}][PTOSCSIGNE]}          |
      ...
      | subject.poleId.v2.id                          | SNSENS:P={goodsConsigneeName15LondonLD12 3ON100}[SNS-C-CONSIGNEE]                                                                 |
      | subject.type                                  | P                                                                                                                                 |
    ...
    And one Event record for "SNS-ASSOC-CCon2Cons" with following attributes
      | metadata.identityRecord.poleId.v2.id          | SNSENS:E={[SNSENS:P={goodsConsigneeName122BristolBR11 1OL100}[SNS-C-CONSIGNEE]][SNSENS:S={movementReferenceNumber789}][PTOSCSIGNE]} |
      | metadata.identityRecord.type                  | E                                                                                                                                   |
      | metadata.sourceRecord.name                    | SNSENS                                                                                                                              |
      | metadata.sourceRecord.shortName               | SNS                                                                                                                                 |
      | metadata.sourceRecord.location                | submissionIdmetadata.messageIdentification                                                                                          |
      | metadata.sourceRecord.id                      | {[SNSENS:P={goodsConsigneeName122BristolBR11 1OL100}[SNS-C-CONSIGNEE]][SNSENS:S={movementReferenceNumber789}][PTOSCSIGNE]}          |
      | metadata.sourceRecord.audit.createdBy         | 0123456789                                                                                                                          |
      | metadata.sourceRecord.audit.createdTimestamp  | 2022-02-22T22:22:22.222Z                                                                                                            |
      | metadata.mappingRecord.name                   | SNS-ASSOC-CCon2Cons                                                                                                                 |
      | metadata.mappingRecord.version                | mappingVersion                                                                                                                      |
      ...
      | snapshotTrigger                               | null                                                                                                                                |
      | type                                          | ASSOCIATION_START                                                                                                                   |
      | subject.poleId.v2.id                          | SNSENS:P={goodsConsigneeName122BristolBR11 1OL100}[SNS-C-CONSIGNEE]                                                                 |
      | subject.type                                  | P                                                                                                                                   |
      | associationStart.type                         | PTOSCSIGNE                                                                                                                          |
  ...
  Scenario: STOP: SSSNS-ASSOC-CCon2Cons not created if name and eori are null
    ...
    Then 0 Event Commands for SNS-ASSOC-CCon2Cons will be emitted
