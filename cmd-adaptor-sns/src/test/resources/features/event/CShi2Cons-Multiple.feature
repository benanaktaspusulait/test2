@EventSnsCShi2ConsMultiple
Feature: Test sns Command Adaptor - Event - Association Start - SNS-ASSOC-CShi2Cons - Multiple
  ...
  Scenario: EventRecord - AssociationStart - SNS-ASSOC-CShi2Cons - Multiple
    When StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 2 Event Commands for SNS-ASSOC-CShi2Cons will be emitted
    And one Event record for "SNS-ASSOC-CShi2Cons" with following attributes
      | metadata.identityRecord.poleId.v2.id          | SNSENS:E={[SNSENS:P={goodsConsignorName11BirminghamBH1 2AM100}[SNS-C-SHIPPER]][SNSENS:S={movementReferenceNumber123}][PTOSSHIP]} |
      ...
      | metadata.sourceRecord.id                      | {[SNSENS:P={goodsConsignorName11BirminghamBH1 2AM100}[SNS-C-SHIPPER]][SNSENS:S={movementReferenceNumber123}][PTOSSHIP]}          |
      ...
      | subject.poleId.v2.id                          | SNSENS:P={goodsConsignorName11BirminghamBH1 2AM100}[SNS-C-SHIPPER]                                                               |
      | subject.type                                  | P                                                                                                                                |
    ...
    And one Event record for "SNS-ASSOC-CShi2Cons" with following attributes
      | metadata.identityRecord.poleId.v2.id          | SNSENS:E={[SNSENS:P={goodsConsignorName140LeedsLE12 0DS100}[SNS-C-SHIPPER]][SNSENS:S={movementReferenceNumber789}][PTOSSHIP]} |
      | metadata.identityRecord.type                  | E                                                                                                                             |
      | metadata.sourceRecord.name                    | SNSENS                                                                                                                        |
      | metadata.sourceRecord.shortName               | SNS                                                                                                                           |
      | metadata.sourceRecord.location                | submissionIdmetadata.messageIdentification                                                                                    |
      | metadata.sourceRecord.id                      | {[SNSENS:P={goodsConsignorName140LeedsLE12 0DS100}[SNS-C-SHIPPER]][SNSENS:S={movementReferenceNumber789}][PTOSSHIP]}          |
      | metadata.sourceRecord.audit.createdBy         | 0123456789                                                                                                                    |
      | metadata.sourceRecord.audit.createdTimestamp  | 2022-02-22T22:22:22.222Z                                                                                                      |
      | metadata.mappingRecord.name                   | SNS-ASSOC-CShi2Cons                                                                                                           |
      | metadata.mappingRecord.version                | mappingVersion                                                                                                                |
      ...
      | snapshotTrigger                               | null                                                                                                                          |
      | type                                          | ASSOCIATION_START                                                                                                             |
      | subject.poleId.v2.id                          | SNSENS:P={goodsConsignorName140LeedsLE12 0DS100}[SNS-C-SHIPPER]                                                               |
      | subject.type                                  | P                                                                                                                             |
      | associationStart.type                         | PTOSSHIP                                                                                                                      |
  ...
  Scenario: STOP: SNS-ASSOC-CShi2Cons not created if name and eori are null
    ...
    Then 0 Event Commands for SNS-ASSOC-CShi2Cons will be emitted
