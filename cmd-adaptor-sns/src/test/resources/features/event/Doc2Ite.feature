@EventSnsDoc2Ite
Feature: Test sns Command Adaptor - Event - Association Start - SNS-ASSOC-Doc2Ite
  ...
  Scenario: EventRecord - AssociationStart - SNS-ASSOC-Doc2Ite
    ...
    Then 1 Event Commands for SNS-ASSOC-Doc2Ite will be emitted
    And one Event record for "SNS-ASSOC-Doc2Ite" with following attributes
      | metadata.identityRecord.poleId.v2.id          | SNSENS:E={[SNSENS:P=null[{test12345EnglishmovementReferenceNumber}],O={test12345EnglishmovementReferenceNumber}][SNSENS:S={movementReferenceNumberIN1234}][OTOSASSO]} |
      ...
      | metadata.sourceRecord.id                      | {[SNSENS:P=null[{test12345EnglishmovementReferenceNumber}],O={test12345EnglishmovementReferenceNumber}][SNSENS:S={movementReferenceNumberIN1234}][OTOSASSO]}          |
      ...
      | subject.poleId.v2.id                          | SNSENS:P=null[{test12345EnglishmovementReferenceNumber}],O={test12345EnglishmovementReferenceNumber}                                                                  |
      | subject.type                                  | O                                                                                                                                                                     |
