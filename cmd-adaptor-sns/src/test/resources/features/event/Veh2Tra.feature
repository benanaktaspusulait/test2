@EventSnsVeh2Tra
Feature: Test sns Command Adaptor - Event - Association Start - SNS-ASSOC-Veh2Tra
  ...
  Scenario: EventRecord - AssociationStart - SNS-ASSOC-Veh2Tra
    When StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 1 Event Commands for SNS-ASSOC-Veh2Tra will be emitted
    And one Event record for "SNS-ASSOC-Veh2Tra" with following attributes
      | metadata.identityRecord.poleId.v2.id          | SNSENS:E={[SNSENS:P=null[{Nationalityvehicle001}],O={Nationalityvehicle001}][SNSENS:P=null[{trailer001NationalitymovementReferenceNumber}],O={trailer001NationalitymovementReferenceNumber}][OTOOLINK]}|
      ...
      | metadata.sourceRecord.id                      | {[SNSENS:P=null[{Nationalityvehicle001}],O={Nationalityvehicle001}][SNSENS:P=null[{trailer001NationalitymovementReferenceNumber}],O={trailer001NationalitymovementReferenceNumber}][OTOOLINK]}|
      ...
      | subject.poleId.v2.id                          | SNSENS:P=null[{Nationalityvehicle001}],O={Nationalityvehicle001}|
      | subject.type                                  | O                                                                                                                              |
      | associationStart.type                         | OTOOLINK                                                                                                                       |
      | associationStart.target.poleId.v2.id          | SNSENS:P=null[{trailer001NationalitymovementReferenceNumber}],O={trailer001NationalitymovementReferenceNumber}|
  ...
  Scenario: EventRecord - AssociationStart - SNS-ASSOC-Veh2Tra
    When the background template of Sns data is changed to
      | field                                                   | value                 |
      #DEV NOTE - | body.itinerary.identityOfMeansOfCrossingBorder.identity | AAA111 BBB222 CCC333 |
      | body.itinerary.identityOfMeansOfCrossingBorder.identity | AAAAA11111 BBBBB22222 |
    And StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 1 Event Commands for SNS-ASSOC-Veh2Tra will be emitted
    And one Event record for "SNS-ASSOC-Veh2Tra" with following attributes
      | metadata.identityRecord.poleId.v2.id          | SNSENS:E={[SNSENS:P=null[{NationalityAAAAA11111}],O={NationalityAAAAA11111}][SNSENS:P=null[{BBBBB22222NationalitymovementReferenceNumber}],O={BBBBB22222NationalitymovementReferenceNumber}][OTOOLINK]} |
      | metadata.identityRecord.type                  | E                                                                                                                              |
      | metadata.sourceRecord.name                    | SNSENS                                                                                                                         |
      | metadata.sourceRecord.shortName               | SNS                                                                                                                            |
      | metadata.sourceRecord.location                | submissionIdmetadata.messageIdentification                                                                                     |
      | metadata.sourceRecord.id                      | {[SNSENS:P=null[{NationalityAAAAA11111}],O={NationalityAAAAA11111}][SNSENS:P=null[{BBBBB22222NationalitymovementReferenceNumber}],O={BBBBB22222NationalitymovementReferenceNumber}][OTOOLINK]}          |
      | metadata.sourceRecord.audit.createdBy         | 0123456789                                                                                                                     |
      | metadata.sourceRecord.audit.createdTimestamp  | 2022-02-22T22:22:22.222Z                                                                                                       |
      | metadata.mappingRecord.name                   | SNS-ASSOC-Veh2Tra                                                                                                              |
      | metadata.mappingRecord.version                | mappingVersion                                                                                                                 |
      ...
      | snapshotTrigger                               | null                                                                                                                           |
      | type                                          | ASSOCIATION_START                                                                                                              |
      | subject.poleId.v2.id                          | SNSENS:P=null[{NationalityAAAAA11111}],O={NationalityAAAAA11111}                                                                                        |
      | subject.type                                  | O                                                                                                                              |
      | associationStart.type                         | OTOOLINK                                                                                                                       |
      | associationStart.target.poleId.v2.id          | SNSENS:P=null[{BBBBB22222NationalitymovementReferenceNumber}],O={BBBBB22222NationalitymovementReferenceNumber}                                                                 |
      | associationStart.target.type                  | O                                                                                                                              |
      | associationStart.timestamp                    | 2022-02-22T22:22:22.222Z                                                                                                       |
      | attributes.attrs.header.ingestDateTime        | 2022-02-22T22:22:22.222Z                                                                                                       |

  Scenario: STOP: SNS-ASSOC-Veh2Tra not created if identity is less than 10 characters long
    When the background template of Sns data is changed to
      | field                                                   | value  |
      | body.itinerary.identityOfMeansOfCrossingBorder.identity | less10 |
    And StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 0 Event Commands for SNS-ASSOC-Veh2Tra will be emitted

  Scenario: STOP: SNS-ASSOC-Veh2Tra not created if modeOfTransportAtBorder is equal to "1"
    When the background template of Sns data is changed to
      | field                                  | value |
  ...
  Scenario: STOP: SNS-ASSOC-Veh2Tra not created identityOfMeansOfCrossingBorder.identity is <=1
    When the background template of Sns data is changed to
      | field                                                   | value |
