@EventSnsCont2Ite
Feature: Test sns Command Adaptor - Event - Association Start - SNS-ASSOC-Cont2Ite
  ...
  Scenario: EventRecord - AssociationStart - SNS-ASSOC-Cont2Ite
    When StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 1 Event Commands for SNS-ASSOC-Cont2Ite will be emitted
    And one Event record for "SNS-ASSOC-Cont2Ite" with following attributes
      | metadata.identityRecord.poleId.v2.id          | SNSENS:E={[SNSENS:P=null[{movementReferenceNumbercont0}],O={movementReferenceNumbercont0}][SNSENS:S={movementReferenceNumberIN1234}][OTOSASSO]} |
      ...
      | metadata.sourceRecord.id                      | {[SNSENS:P=null[{movementReferenceNumbercont0}],O={movementReferenceNumbercont0}][SNSENS:S={movementReferenceNumberIN1234}][OTOSASSO]}          |
      ...
      | subject.poleId.v2.id                          | SNSENS:P=null[{movementReferenceNumbercont0}],O={movementReferenceNumbercont0}                                                                  |
      | subject.type                                  | O                                                                                                                                               |
  ...
  Scenario Outline: STOP: SNS-ASSOC-Cont2Ite not created if containerNumber is blank or null
    ...
    Then 0 Event Commands for SNS-ASSOC-Cont2Ite will be emitted
    Examples:
      | container |
      | [blank]   |
      | null      |
