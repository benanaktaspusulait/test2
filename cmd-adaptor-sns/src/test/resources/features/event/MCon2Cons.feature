@EventSnsMCon2Cons
Feature: Test sns Command Adaptor - Event - Association Start - SNS-ASSOC-MCon2Cons
  ...
  Scenario: EventRecord - AssociationStart - SNS-ASSOC-MCon2Cons
    When StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 1 Event Commands for SNS-ASSOC-MCon2Cons will be emitted
    And one Event record for "SNS-ASSOC-MCon2Cons" with following attributes
      | metadata.identityRecord.poleId.v2.id          | SNSENS:E={[SNSENS:P={partiesConsigneeName23ParisPA12 IS200}[SNS-M-CONSIGNEE]][SNSENS:S={movementReferenceNumber123}][PTOSCSIGNE]} |
      ...
      | metadata.sourceRecord.id                      | {[SNSENS:P={partiesConsigneeName23ParisPA12 IS200}[SNS-M-CONSIGNEE]][SNSENS:S={movementReferenceNumber123}][PTOSCSIGNE]}          |
      ...
      | subject.poleId.v2.id                          | SNSENS:P={partiesConsigneeName23ParisPA12 IS200}[SNS-M-CONSIGNEE]                                                                 |
      | subject.type                                  | P                                                                                                                                 |
  ...
  Scenario: STOP: SNS-ASSOC-MCon2Cons not created if name and eori are null
    ...
    Then 0 Event Commands for SNS-ASSOC-MCon2Cons will be emitted
