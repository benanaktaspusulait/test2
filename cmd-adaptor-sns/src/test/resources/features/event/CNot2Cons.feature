@EventSnsCNot2Cons
Feature: Test sns Command Adaptor - Event - Association Start - SNS-ASSOC-CNot2Cons
  ...
  Scenario: EventRecord - AssociationStart - SNS-ASSOC-CNot2Cons
  ...
  Scenario: STOP: SNS-ASSOC-CNot2Cons not created if name and eori are null
    ...
    Then 0 Event Commands for SNS-ASSOC-CNot2Cons will be emitted
