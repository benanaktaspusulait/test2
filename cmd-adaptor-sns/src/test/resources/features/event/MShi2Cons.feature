@EventSnsMShi2Cons
Feature: Test sns Command Adaptor - Event - Association Start - SNS-ASSOC-MShi2Cons
  ...
  Scenario: EventRecord - AssociationStart - SNS-ASSOC-MShi2Cons
    When StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 1 Event Commands for SNS-ASSOC-MShi2Cons will be emitted
    And one Event record for "SNS-ASSOC-MShi2Cons" with following attributes
      | metadata.identityRecord.poleId.v2.id          | SNSENS:E={[SNSENS:P={partiesConsignorName90CardiffCA34 7FF100}[SNS-M-SHIPPER]][SNSENS:S={movementReferenceNumber123}][PTOSSHIP]} |
      ...
      | metadata.sourceRecord.id                      | {[SNSENS:P={partiesConsignorName90CardiffCA34 7FF100}[SNS-M-SHIPPER]][SNSENS:S={movementReferenceNumber123}][PTOSSHIP]}          |
      ...
      | subject.poleId.v2.id                          | SNSENS:P={partiesConsignorName90CardiffCA34 7FF100}[SNS-M-SHIPPER]                                                               |
      | subject.type                                  | P                                                                                                                                |
  ...
  Scenario: STOP: SNS-ASSOC-MShi2Cons not created if name and eori are null
    ...
    Then 0 Event Commands for SNS-ASSOC-MShi2Cons will be emitted
