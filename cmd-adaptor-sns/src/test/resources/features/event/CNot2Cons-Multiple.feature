@EventSnsCNot2ConsMultiple
Feature: Test sns Command Adaptor - Event - Association Start - SNS-ASSOC-CNot2Cons - Multiple
  ...
  Scenario: EventRecord - AssociationStart - "SNS-ASSOC-CNot2Cons" - Multiple
    When StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 2 Event Commands for SNS-ASSOC-CNot2Cons will be emitted
    And one Event record for "SNS-ASSOC-CNot2Cons" with following attributes
      | metadata.identityRecord.poleId.v2.id          | SNSENS:E={[SNSENS:P={notifyPartyName100ReadingRG1 0NG100}[SNS-C-NOTIFY]][SNSENS:S={movementReferenceNumber123}][PTOS]} |
      ...
      | metadata.sourceRecord.id                      | {[SNSENS:P={notifyPartyName100ReadingRG1 0NG100}[SNS-C-NOTIFY]][SNSENS:S={movementReferenceNumber123}][PTOS]}          |
      ...
      | subject.poleId.v2.id                          | SNSENS:P={notifyPartyName100ReadingRG1 0NG100}[SNS-C-NOTIFY]                                                           |
      | subject.type                                  | P                                                                                                                      |
    ...
    And one Event record for "SNS-ASSOC-CNot2Cons" with following attributes
      | metadata.identityRecord.poleId.v2.id          | SNSENS:E={[SNSENS:P={notifyPartyName166LiverpoolLI90 POL100}[SNS-C-NOTIFY]][SNSENS:S={movementReferenceNumber789}][PTOS]} |
      | metadata.identityRecord.type                  | E                                                                                                                         |
      | metadata.sourceRecord.name                    | SNSENS                                                                                                                    |
      | metadata.sourceRecord.shortName               | SNS                                                                                                                       |
      | metadata.sourceRecord.location                | submissionIdmetadata.messageIdentification                                                                                |
      | metadata.sourceRecord.id                      | {[SNSENS:P={notifyPartyName166LiverpoolLI90 POL100}[SNS-C-NOTIFY]][SNSENS:S={movementReferenceNumber789}][PTOS]}          |
      | metadata.sourceRecord.audit.createdBy         | 0123456789                                                                                                                |
      | metadata.sourceRecord.audit.createdTimestamp  | 2022-02-22T22:22:22.222Z                                                                                                  |
      | metadata.mappingRecord.name                   | SNS-ASSOC-CNot2Cons                                                                                                       |
      | metadata.mappingRecord.version                | mappingVersion                                                                                                            |
      ...
      | snapshotTrigger                               | null                                                                                                                      |
      | type                                          | ASSOCIATION_START                                                                                                         |
      | subject.poleId.v2.id                          | SNSENS:P={notifyPartyName166LiverpoolLI90 POL100}[SNS-C-NOTIFY]                                                           |
      | subject.type                                  | P                                                                                                                         |
      | associationStart.type                         | PTOS                                                                                                                      |
  ...
  Scenario: STOP: SNS-ASSOC-CNot2Cons not created if name and eori are null
    ...
    Then 1 Event Commands for SNS-ASSOC-CNot2Cons will be emitted

  Scenario: STOP: SNS-ASSOC-CNot2Cons not created if itemNumber is null
    When the background template of Sns data is changed to
      | field                              | value |
      | body.goods.goodsItems.1.itemNumber | null  |
    And StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 1 Event Commands for SNS-ASSOC-CNot2Cons will be emitted
