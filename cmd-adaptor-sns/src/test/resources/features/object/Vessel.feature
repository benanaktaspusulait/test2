@objectMVessel
Feature: SNS Command Adaptor - Object - SNS-M-VESSEL
  ...
  Scenario: ObjectRecord - SNS-M-VESSEL
    When StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 1 Object Commands for SNS-M-VESSEL will be emitted
    And one Object record for "SNS-M-VESSEL" with following attributes
      | metadata.identityRecord.poleId.v2.id                                | SNSENS:P=null[{IMO1234567Nationality}],O={IMO1234567Nationality} |
      ...
      | metadata.sourceRecord.id                                            | {IMO1234567Nationality}                                          |
      ...
      | party.poleId.v2.id                                                  | SNSENS:P=null[{IMO1234567Nationality}]                           |
      | party.type                                                          | P                                                                |
      | role                                                                | PTOOLINK                                                         |
      ...
      | vessel.registrationCountry                                          | Nationality                                                      |
      | vessel.registrationNumber                                           | null                                                             |
      | vessel.registrationPort                                             | null                                                             |


  Scenario: STOP: SNS-M-VESSEL not created if modeOfTransportAtBorder is not 1 (maritime)
    ...
    Then 0 Object Commands for SNS-M-VESSEL will be emitted

  Scenario: STOP: SNS-M-VESSEL  not created if length identityOfMeansOfCrossingBorder.identity >= 10
    When the background template of Sns data is changed to
      | field                                                      | value       |
