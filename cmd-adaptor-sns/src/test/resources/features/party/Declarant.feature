@OrganisationSnsDeclarant
Feature: Test sns Command Adaptor - Party - Organisation - SNS-DECLARANT
  ...
  Scenario: PartyRecord - Organisation - SNS-DECLARANT
    When StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 1 Party Commands for SNS-DECLARANT will be emitted
    And one Party record for "SNS-DECLARANT" with following attributes
      | metadata.identityRecord.poleId.v2.id          | SNSENS:P={declarantName100BathBA44 4TH100}[SNS-DECLARANT] |
      ...
      | metadata.sourceRecord.id                      | {declarantName100BathBA44 4TH100}                         |
      ...
      | organisation.name                             | declarantName                                             |
  ...
  Scenario: SNS-DECLARANT is created if EORI is not null
    ...
    And one Party record for "SNS-DECLARANT" with following attributes
      ...
      | attributes.attrs.header.ingestDateTime         | 2022-02-22T22:22:22.222Z                   |
      | attributes.attrs.parties.declarant.language    | parties.declarant.language                 |
      | attributes.attrs.parties.declarant.eori        | EORI56                                     |
  ...
  Scenario: STOP: SNS-DECLARANT not created if name and eori are null
    When the background template of Sns data is changed to
      | field                       | value |
      | body.parties.declarant.name | null  |
      | body.parties.declarant.eori | null  |
    And StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 0 Party Commands for SNS-DECLARANT will be emitted
