@OrganisationSnsCConsigneeMultiple
Feature: Test sns Command Adaptor - Party - Organisation - SNS-C-CONSIGNEE multiple
  ...
  Background:
    Given template StreamIngestRecord source data with the following attributes
      ...
      | body.goods.goodsItems.1.consignee.eori                                | null                                                             |
  ...
  Scenario: PartyRecord - Organisation - SNS-C-CONSIGNEE multiple
    When StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 2 Party Commands for SNS-C-CONSIGNEE will be emitted
    And one Party record for "SNS-C-CONSIGNEE" with following attributes
      | metadata.identityRecord.poleId.v2.id                 | SNSENS:P={goodsConsigneeName15LondonLD12 3ON100}[SNS-C-CONSIGNEE] |
      ...
      | metadata.sourceRecord.id                             | {goodsConsigneeName15LondonLD12 3ON100}                           |
      ...
      | organisation.name                                    | goodsConsigneeName                                                |
    ...
    And one Party record for "SNS-C-CONSIGNEE" with following attributes
      | metadata.identityRecord.poleId.v2.id                 | SNSENS:P={goodsConsigneeName122BristolBR11 1OL100}[SNS-C-CONSIGNEE] |
      | metadata.identityRecord.type                         | P                                                                   |
      | metadata.sourceRecord.name                           | SNSENS                                                              |
      | metadata.sourceRecord.shortName                      | SNS                                                                 |
      | metadata.sourceRecord.location                       | submissionIdmetadata.messageIdentification                          |
      | metadata.sourceRecord.id                             | {goodsConsigneeName122BristolBR11 1OL100}                           |
      | metadata.sourceRecord.audit.createdBy                | 0123456789                                                          |
      | metadata.sourceRecord.audit.createdTimestamp         | 2022-02-22T22:22:22.222Z                                            |
      | metadata.mappingRecord.name                          | SNS-C-CONSIGNEE                                                     |
      | metadata.mappingRecord.version                       | mappingVersion                                                      |
      ...
      | type                                                 | ORGANISATION                                                        |
      | organisation.type                                    | ORGCSIGNEE                                                          |
      | organisation.name                                    | goodsConsigneeName1                                                 |
      | organisation.registrationNumber                      | null                                                                |
      | organisation.vatNumber                               | null                                                                |
      | organisation.industrySector                          | null                                                                |
      | organisation.numberOfEmployees                       | null                                                                |
  ...
  Scenario: SNS-C-CONSIGNEE is created if eori is not null
    When the background template of Sns data is changed to
      | field                                  | value  |
      | body.goods.goodsItems.0.consignee.eori | EORI56 |
      | body.goods.goodsItems.1.consignee.eori | EORI57 |
    And StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 2 Party Commands for SNS-C-CONSIGNEE will be emitted
    And one Party record for "SNS-C-CONSIGNEE" with following attributes
      | metadata.identityRecord.poleId.v2.id                 | SNSENS:P={EORI56}[SNS-C-CONSIGNEE]         |
      | metadata.identityRecord.type                         | P                                          |
      | metadata.sourceRecord.name                           | SNSENS                                     |
      | metadata.sourceRecord.shortName                      | SNS                                        |
      | metadata.sourceRecord.location                       | submissionIdmetadata.messageIdentification |
      ...
      | attributes.attrs.header.ingestDateTime               | 2022-02-22T22:22:22.222Z                   |
      | attributes.attrs.goods.goodsItems.consignee.language | goods.goodsItems.0.consignee.language      |
      | attributes.attrs.goods.goodsItems.consignee.eori     | EORI56                                     |
    ...
    And one Party record for "SNS-C-CONSIGNEE" with following attributes
      | metadata.identityRecord.poleId.v2.id                 | SNSENS:P={EORI57}[SNS-C-CONSIGNEE]         |
      | metadata.identityRecord.type                         | P                                          |
      | metadata.sourceRecord.name                           | SNSENS                                     |
      | metadata.sourceRecord.shortName                      | SNS                                        |
      | metadata.sourceRecord.location                       | submissionIdmetadata.messageIdentification |
      ...
      | attributes.attrs.header.ingestDateTime               | 2022-02-22T22:22:22.222Z                   |
      | attributes.attrs.goods.goodsItems.consignee.language | goods.goodsItems.1.consignee.language      |
      | attributes.attrs.goods.goodsItems.consignee.eori     | EORI57                                     |
  ...
  Scenario: STOP: SNS-C-CONSIGNEE not created if name and eori are null
    When the background template of Sns data is changed to
      | field                                  | value |
      | body.goods.goodsItems.0.consignee.name | null  |
      | body.goods.goodsItems.0.consignee.eori | null  |
      | body.goods.goodsItems.1.consignee.name | null  |
      | body.goods.goodsItems.1.consignee.eori | null  |
    And StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 0 Party Commands for SNS-C-CONSIGNEE will be emitted
