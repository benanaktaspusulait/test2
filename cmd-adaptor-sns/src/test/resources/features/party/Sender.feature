@PartySnsSender
Feature: Test sns Command Adaptor - Party - Organisation - SNS-SENDER
#unable to test the stop node,
# as the customEORILookupNull custom function is hardcode to return false
# This logic needs updating in customEORILookupNull in future
  Background:
  ...
  Scenario: PartyRecord - Organisation - SNS-SENDER
    ...
    And one Party record for "SNS-SENDER" with following attributes
      ...
      | metadata.sourceRecord.id                       | {EORI765}                                  |
      ...
      | organisation.name                              | EORI765                                    |
      | organisation.registrationNumber                | null                                       |
      | organisation.vatNumber                         | EORI765                                    |
      ...
      | attributes.attrs.eoriExtractionType            | EORI765                                    |
      | attributes.attrs.eoriPrincipalEconomicActivity | EORI765                                    |
      | attributes.attrs.eoriVatRegistrationNumber     | EORI765                                    |
      | attributes.attrs.eoriSendingDateTime           | EORI765                                    |
      | attributes.attrs.eoriDateOfRegistration        | EORI765                                    |
      | attributes.attrs.eoriTraderName                | EORI765                                    |
