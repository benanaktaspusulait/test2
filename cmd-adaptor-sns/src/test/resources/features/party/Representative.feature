@OrganisationSnsRepresentative
Feature: Test sns Command Adaptor - Party - Organisation - SNS-REPRESENTATIVE
  ...
  Scenario: PartyRecord - Organisation - SNS-REPRESENTATIVE
    When StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 1 Party Commands for SNS-REPRESENTATIVE will be emitted
    And one Party record for "SNS-REPRESENTATIVE" with following attributes
      | metadata.identityRecord.poleId.v2.id             | SNSENS:P={representativeName33LondonLN12 7ON100}[SNS-REPRESENTATIVE] |
      ...
      | metadata.sourceRecord.id                         | {representativeName33LondonLN12 7ON100}                              |
      ...
      | organisation.name                                | representativeName                                                   |
  ...
  Scenario: SNS-REPRESENTATIVE not created if EORI is not null
    ...
    And one Party record for "SNS-REPRESENTATIVE" with following attributes
      ...
      | attributes.attrs.header.ingestDateTime           | 2022-02-22T22:22:22.222Z                   |
      | attributes.attrs.parties.representative.language | parties.representative.language            |
      | attributes.attrs.parties.representative.eori     | EORI56                                     |
  ...
  Scenario: STOP: SNS-REPRESENTATIVE not created if name and eori are null
    When the background template of Sns data is changed to
      | field                            | value |
      | body.parties.representative.name | null  |
      | body.parties.representative.eori | null  |
    And StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 0 Party Commands for SNS-REPRESENTATIVE will be emitted
