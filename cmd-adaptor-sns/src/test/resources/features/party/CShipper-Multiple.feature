@OrganisationSnsCShipperMultiple
Feature: Test sns Command Adaptor - Party - Organisation - SNS-C-SHIPPER multiple
  ...
  Background:
    Given template StreamIngestRecord source data with the following attributes
      ...
      | body.goods.goodsItems.1.consignor.eori                                | null                                                             |
  ...
  Scenario: PartyRecord - Organisation - SNS-C-SHIPPER multiple
    When StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 2 Party Commands for SNS-C-SHIPPER will be emitted
    And one Party record for "SNS-C-SHIPPER" with following attributes
      | metadata.identityRecord.poleId.v2.id                 | SNSENS:P={goodsConsignorName11BirminghamBH1 2AM100}[SNS-C-SHIPPER] |
      ...
      | metadata.sourceRecord.id                             | {goodsConsignorName11BirminghamBH1 2AM100}                         |
      ...
      | organisation.name                                    | goodsConsignorName                                                 |
      ...
      | attributes.attrs.goods.goodsItems.consignor.language | goods.goodsItems.0.consignor.language                              |

    And one Party record for "SNS-C-SHIPPER" with following attributes
      | metadata.identityRecord.poleId.v2.id                 | SNSENS:P={goodsConsignorName140LeedsLE12 0DS100}[SNS-C-SHIPPER] |
      | metadata.identityRecord.type                         | P                                                               |
      | metadata.sourceRecord.name                           | SNSENS                                                          |
      | metadata.sourceRecord.shortName                      | SNS                                                             |
      | metadata.sourceRecord.location                       | submissionIdmetadata.messageIdentification                      |
      | metadata.sourceRecord.id                             | {goodsConsignorName140LeedsLE12 0DS100}                         |
      | metadata.sourceRecord.audit.createdBy                | 0123456789                                                      |
      | metadata.sourceRecord.audit.createdTimestamp         | 2022-02-22T22:22:22.222Z                                        |
      | metadata.mappingRecord.name                          | SNS-C-SHIPPER                                                   |
      | metadata.mappingRecord.version                       | mappingVersion                                                  |
      ...
      | type                                                 | ORGANISATION                                                    |
      | organisation.type                                    | ORGSHIPPER                                                      |
      | organisation.name                                    | goodsConsignorName1                                             |
      | organisation.registrationNumber                      | null                                                            |
      | organisation.vatNumber                               | null                                                            |
      | organisation.industrySector                          | null                                                            |
      | organisation.numberOfEmployees                       | null                                                            |
  ...
  Scenario: SNS-C-SHIPPER is created if EORI is not null
    When the background template of Sns data is changed to
      | field                                  | value  |
      | body.goods.goodsItems.0.consignor.eori | EORI56 |
      | body.goods.goodsItems.1.consignor.eori | EORI57 |
    And StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 2 Party Commands for SNS-C-SHIPPER will be emitted
    And one Party record for "SNS-C-SHIPPER" with following attributes
      | metadata.identityRecord.poleId.v2.id                 | SNSENS:P={EORI56}[SNS-C-SHIPPER]           |
      | metadata.identityRecord.type                         | P                                          |
      | metadata.sourceRecord.name                           | SNSENS                                     |
      | metadata.sourceRecord.shortName                      | SNS                                        |
      | metadata.sourceRecord.location                       | submissionIdmetadata.messageIdentification |
      | metadata.sourceRecord.id                             | {EORI56}                                   |
      | metadata.sourceRecord.audit.createdBy                | 0123456789                                 |
      | metadata.sourceRecord.audit.createdTimestamp         | 2022-02-22T22:22:22.222Z                   |
      | metadata.mappingRecord.name                          | SNS-C-SHIPPER                              |
      | metadata.mappingRecord.version                       | mappingVersion                             |
      ...
      | organisation.name                                    | goodsConsignorName                         |
      | organisation.registrationNumber                      | null                                       |
      | organisation.vatNumber                               | EORI56                                     |
      | organisation.industrySector                          | null                                       |
      | organisation.numberOfEmployees                       | null                                       |
      | attributes.attrs.header.ingestDateTime               | 2022-02-22T22:22:22.222Z                   |
      | attributes.attrs.goods.goodsItems.consignor.language | goods.goodsItems.0.consignor.language      |
      | attributes.attrs.goods.goodsItems.consignor.eori     | EORI56                                     |
      | attributes.attrs.eoriExtractionType                  | EORI56                                     |
      | attributes.attrs.eoriPrincipalEconomicActivity       | EORI56                                     |
      | attributes.attrs.eoriVatRegistrationNumber           | EORI56                                     |
      | attributes.attrs.eoriSendingDateTime                 | EORI56                                     |
      | attributes.attrs.eoriDateOfRegistration              | EORI56                                     |
      | attributes.attrs.eoriTraderName                      | EORI56                                     |
    And one Party record for "SNS-C-SHIPPER" with following attributes
      | metadata.identityRecord.poleId.v2.id                 | SNSENS:P={EORI57}[SNS-C-SHIPPER]           |
      | metadata.identityRecord.type                         | P                                          |
      | metadata.sourceRecord.name                           | SNSENS                                     |
      | metadata.sourceRecord.shortName                      | SNS                                        |
      | metadata.sourceRecord.location                       | submissionIdmetadata.messageIdentification |
      | metadata.sourceRecord.id                             | {EORI57}                                   |
      | metadata.sourceRecord.audit.createdBy                | 0123456789                                 |
      | metadata.sourceRecord.audit.createdTimestamp         | 2022-02-22T22:22:22.222Z                   |
      | metadata.mappingRecord.name                          | SNS-C-SHIPPER                              |
      | metadata.mappingRecord.version                       | mappingVersion                             |
      ...
      | organisation.name                                    | goodsConsignorName1                        |
      | organisation.registrationNumber                      | null                                       |
      | organisation.vatNumber                               | EORI57                                     |
      | organisation.industrySector                          | null                                       |
      | organisation.numberOfEmployees                       | null                                       |
      | attributes.attrs.header.ingestDateTime               | 2022-02-22T22:22:22.222Z                   |
      | attributes.attrs.goods.goodsItems.consignor.language | goods.goodsItems.0.consignor.language      |
      | attributes.attrs.goods.goodsItems.consignor.eori     | EORI57                                     |
      | attributes.attrs.eoriExtractionType                  | EORI57                                     |
      | attributes.attrs.eoriPrincipalEconomicActivity       | EORI57                                     |
      | attributes.attrs.eoriVatRegistrationNumber           | EORI57                                     |
      | attributes.attrs.eoriSendingDateTime                 | EORI57                                     |
      | attributes.attrs.eoriDateOfRegistration              | EORI57                                     |
      | attributes.attrs.eoriTraderName                      | EORI57                                     |

  Scenario: STOP: SNS-C-SHIPPER not created if name and eori are null
    When the background template of Sns data is changed to
      | field                                  | value |
      | body.goods.goodsItems.0.consignor.name | null  |
      | body.goods.goodsItems.0.consignor.eori | null  |
      | body.goods.goodsItems.1.consignor.name | null  |
      | body.goods.goodsItems.1.consignor.eori | null  |
    And StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 0 Party Commands for SNS-C-SHIPPER will be emitted
