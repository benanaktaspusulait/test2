...
public class EoriDateOfRegLookup extends BaseEoriLookup {

    protected EoriDateOfRegLookup(LookupKafkaSerdeConfig lookupConfig,
    ...
    public CharSequence lookup(CharSequence key) {
        ...
        return lookupEoriValue == null ? null : lookupEoriValue.getDateOfRegistration();
    }
}