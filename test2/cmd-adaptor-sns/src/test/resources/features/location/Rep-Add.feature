@locationRepAdd
Feature: SNS Command Adaptor - Location - SNS-REP-ADD
  ...
  Scenario: LocationRecord - SNS-REP-ADD
    When StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 1 Location Commands for SNS-REP-ADD will be emitted
    And one Location record for "SNS-REP-ADD" with following attributes
      | metadata.identityRecord.poleId.v2.id          | SNSENS:P={representativeName33LondonLN12 7ON100}[SNS-REPRESENTATIVE],L={33LondonLN12 7ON100} |
      ...
      | endTimestamp                                  | null                                                                                         |
      | type                                          | ADDRESS                                                                                      |
      | party.poleId.v2.id                            | SNSENS:P={representativeName33LondonLN12 7ON100}[SNS-REPRESENTATIVE]                         |
      | party.type                                    | P                                                                                            |
      | role                                          | PTOLASSO                                                                                     |
      | address.type                                  | LOCADDR                                                                                      |
      | address.postCode                              | LN12 7ON                                                                                     |
      | address.poBox                                 | null                                                                                         |
      | address.fullAddress                           | representativeName 33 London LN12 7ON 100                                                    |
      | address.name                                  | representativeName                                                                           |
  ...
  Scenario: STOP: SNS-REP-ADD not created if representative.name and eori are null
    ...
    Then 0 Location Commands for SNS-REP-ADD will be emitted
