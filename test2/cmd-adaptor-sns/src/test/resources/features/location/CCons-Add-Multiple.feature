@locationCConsAddMultiple
Feature: SNS Command Adaptor - Location - SNS-C-CONS-ADD Multiple
  ...
  Scenario: LocationRecord - SNS-C-CONS-ADD Multiple
    When StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 2 Location Commands for SNS-C-CONS-ADD will be emitted
    And one Location record for "SNS-C-CONS-ADD" with following attributes
      | metadata.identityRecord.poleId.v2.id          | SNSENS:P={goodsConsigneeName15LondonLD12 3ON100}[SNS-C-CONSIGNEE],L={15LondonLD12 3ON100} |
      ...
      | type                                          | ADDRESS                                                                                   |
      | party.poleId.v2.id                            | SNSENS:P={goodsConsigneeName15LondonLD12 3ON100}[SNS-C-CONSIGNEE]                         |
      | party.type                                    | P                                                                                         |
      | role                                          | PTOLCSIGNE                                                                                |
      | address.type                                  | LOCADDR                                                                                   |
      | address.postCode                              | LD12 3ON                                                                                  |
      | address.poBox                                 | null                                                                                      |
      | address.fullAddress                           | goodsConsigneeName 15 London LD12 3ON 100                                                 |
      | address.name                                  | goodsConsigneeName                                                                        |
    ...
    And one Location record for "SNS-C-CONS-ADD" with following attributes
      | metadata.identityRecord.poleId.v2.id          | SNSENS:P={goodsConsigneeName122BristolBR11 1OL100}[SNS-C-CONSIGNEE],L={22BristolBR11 1OL100} |
      | metadata.identityRecord.type                  | L                                                                                            |
      | metadata.sourceRecord.name                    | SNSENS                                                                                       |
      | metadata.sourceRecord.shortName               | SNS                                                                                          |
      | metadata.sourceRecord.location                | submissionIdmetadata.messageIdentification                                                   |
      ...
      | snapshotTrigger                               | null                                                                                         |
      | type                                          | ADDRESS                                                                                      |
      | party.poleId.v2.id                            | SNSENS:P={goodsConsigneeName122BristolBR11 1OL100}[SNS-C-CONSIGNEE]                          |
      | party.type                                    | P                                                                                            |
      | role                                          | PTOLCSIGNE                                                                                   |
      | address.type                                  | LOCADDR                                                                                      |
      | address.postCode                              | BR11 1OL                                                                                     |
      | address.poBox                                 | null                                                                                         |
      | address.fullAddress                           | goodsConsigneeName1 22 Bristol BR11 1OL 100                                                  |
      | address.name                                  | goodsConsigneeName1                                                                          |
      | address.siteLocation                          | null                                                                                         |
      | address.number                                | null                                                                                         |
      | address.street                                | 22                                                                                           |
  ...
  Scenario: STOP: SNS-C-CONS-ADD not created if name and eori are null
    ...
    Then 0 Location Commands for SNS-C-CONS-ADD will be emitted
