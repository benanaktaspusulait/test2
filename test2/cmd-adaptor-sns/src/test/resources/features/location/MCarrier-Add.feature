@locationMConsAdd
Feature: SNS Command Adaptor - Location - SNS-M-CARRIER-ADD
  ...
  Background:
    Given template StreamIngestRecord source data with the following attributes
      ...
      | body.parties.carrier.name                                             | name                                                             |
  ...
  Scenario: LocationRecord - SNS-M-CARRIER-ADD
    When StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 1 Location Commands for SNS-M-CARRIER-ADD will be emitted
    And one Location record for "SNS-M-CARRIER-ADD" with following attributes
      | metadata.identityRecord.poleId.v2.id          | SNSENS:P={namestreetAndNumbercitypostalCodecountryCode}[SNS-M-CARRIER],L={streetAndNumbercitypostalCodecountryCode} |
      ...
      | metadata.sourceRecord.id                      | {streetAndNumbercitypostalCodecountryCode}                                                                          |
      ...
      | endTimestamp                                  | null                                                                                                                |
      | type                                          | ADDRESS                                                                                                             |
      | party.poleId.v2.id                            | SNSENS:P={namestreetAndNumbercitypostalCodecountryCode}[SNS-M-CARRIER]                                              |
      | party.type                                    | P                                                                                                                   |
      | role                                          | PTOLASSO                                                                                                            |
      | address.type                                  | LOCADDR                                                                                                             |
      | address.postCode                              | postalCode                                                                                                          |
      | address.poBox                                 | null                                                                                                                |
      | address.fullAddress                           | name streetAndNumber city postalCode countryCode                                                                    |
      | address.name                                  | name                                                                                                                |
  ...
  Scenario: STOP: SNS-M-CONS-ADD not created if name and eori are null
    ...
    Then 0 Location Commands for SNS-M-CARRIER-ADD will be emitted
