@locationCShipAddMultiple
Feature: SNS Command Adaptor - Location - SNS-C-SHIP-ADD Multiple
  ...
  Scenario: LocationRecord - SNS-C-SHIP-ADD Multiple
    When StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 2 Location Commands for SNS-C-SHIP-ADD will be emitted
    And one Location record for "SNS-C-SHIP-ADD" with following attributes
      | metadata.identityRecord.poleId.v2.id          | SNSENS:P={goodsConsignorName11BirminghamBH1 2AM100}[SNS-C-SHIPPER],L={11BirminghamBH1 2AM100} |
      ...
      | endTimestamp                                  | null                                                                                          |
      | type                                          | ADDRESS                                                                                       |
      | party.poleId.v2.id                            | SNSENS:P={goodsConsignorName11BirminghamBH1 2AM100}[SNS-C-SHIPPER]                            |
      | party.type                                    | P                                                                                             |
      | role                                          | PTOLSHIP                                                                                      |
      | address.type                                  | LOCADDR                                                                                       |
      | address.postCode                              | BH1 2AM                                                                                       |
      | address.poBox                                 | null                                                                                          |
      | address.fullAddress                           | goodsConsignorName 11 Birmingham BH1 2AM 100                                                  |
      | address.name                                  | goodsConsignorName                                                                            |
    ...
    And one Location record for "SNS-C-SHIP-ADD" with following attributes
      | metadata.identityRecord.poleId.v2.id          | SNSENS:P={goodsConsignorName140LeedsLE12 0DS100}[SNS-C-SHIPPER],L={40LeedsLE12 0DS100} |
      | metadata.identityRecord.type                  | L                                                                                      |
      | metadata.sourceRecord.name                    | SNSENS                                                                                 |
      | metadata.sourceRecord.shortName               | SNS                                                                                    |
      | metadata.sourceRecord.location                | submissionIdmetadata.messageIdentification                                             |
      ...
      | snapshotTrigger                               | null                                                                                   |
      | type                                          | ADDRESS                                                                                |
      | party.poleId.v2.id                            | SNSENS:P={goodsConsignorName140LeedsLE12 0DS100}[SNS-C-SHIPPER]                        |
      | party.type                                    | P                                                                                      |
      | role                                          | PTOLSHIP                                                                               |
      | address.type                                  | LOCADDR                                                                                |
      | address.postCode                              | LE12 0DS                                                                               |
      | address.poBox                                 | null                                                                                   |
      | address.fullAddress                           | goodsConsignorName1 40 Leeds LE12 0DS 100                                              |
      | address.name                                  | goodsConsignorName1                                                                    |
      | address.siteLocation                          | null                                                                                   |
      | address.number                                | null                                                                                   |
      | address.street                                | 40                                                                                     |
      | address.town                                  | Leeds                                                                                  |
  ...
  Scenario: STOP: SNS-C-SHIP-ADD not created if name and eori are null
    ...
    Then 0 Location Commands for SNS-C-SHIP-ADD will be emitted
