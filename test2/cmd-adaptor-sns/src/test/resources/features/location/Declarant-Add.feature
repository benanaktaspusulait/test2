@locationDeclarantAdd
Feature: SNS Command Adaptor - Location - SNS-DECLARANT-ADD
  ...
  Scenario: LocationRecord - SNS-DECLARANT-ADD
    When StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 1 Location Commands for SNS-DECLARANT-ADD will be emitted
    And one Location record for "SNS-DECLARANT-ADD" with following attributes
      | metadata.identityRecord.poleId.v2.id          | SNSENS:P={declarantName100BathBA44 4TH100}[SNS-DECLARANT],L={100BathBA44 4TH100} |
      ...
      | endTimestamp                                  | null                                                                             |
      | type                                          | ADDRESS                                                                          |
      | party.poleId.v2.id                            | SNSENS:P={declarantName100BathBA44 4TH100}[SNS-DECLARANT]                        |
      | party.type                                    | P                                                                                |
      | role                                          | PTOLASSO                                                                         |
      | address.type                                  | LOCADDR                                                                          |
      | address.postCode                              | BA44 4TH                                                                         |
      | address.poBox                                 | null                                                                             |
      | address.fullAddress                           | declarantName 100 Bath BA44 4TH 100                                              |
      | address.name                                  | declarantName                                                                    |
  ...
  Scenario: STOP: SNS-DECLARANT-ADD not created if declarant.name and eori are null
    ...
    Then 0 Location Commands for SNS-DECLARANT-ADD will be emitted
