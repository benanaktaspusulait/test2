@objectDocument
Feature: SNS Command Adaptor - Object - SNS-DOCUMENT
  ...
  Scenario: ObjectRecord - SNS-DOCUMENT
    ...
    Then 1 Object Commands for SNS-DOCUMENT will be emitted
    And one Object record for "SNS-DOCUMENT" with following attributes
      | metadata.identityRecord.poleId.v2.id                 | SNSENS:P=null[{test12345EnglishmovementReferenceNumber}],O={test12345EnglishmovementReferenceNumber} |
      ...
      | metadata.sourceRecord.id                             | {test12345EnglishmovementReferenceNumber}                                                            |
      ...
      | party.poleId.v2.id                                   | SNSENS:P=null[{test12345EnglishmovementReferenceNumber}]                                             |
      | party.type                                           | P                                                                                                    |
      | role                                                 | PTOOLINK                                                                                             |
