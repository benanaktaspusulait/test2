@objectTrailer
Feature: SNS Command Adaptor - Object - SNS-M-TRAILER
  ...
  Scenario Outline: ObjectRecord - SNS-M-TRAILER
    ...
    Then 1 Object Commands for SNS-M-TRAILER will be emitted
    And one Object record for "SNS-M-TRAILER" with following attributes
      | metadata.identityRecord.poleId.v2.id                                | SNSENS:P=null[{trailer001NationalitymovementReferenceNumber}],O={trailer001NationalitymovementReferenceNumber} |
      ...
      | metadata.sourceRecord.id                                            | {trailer001NationalitymovementReferenceNumber}                                                                 |
      ...
      | vehicle.model                                                       | null                                                                                                           |
      | vehicle.vin                                                         | null                                                                                                           |
      | vehicle.registrationCountry                                         | Nationality                                                                                                    |
      | vehicle.registrationNumber                                          | trailer001                                                                                                     |
      | vehicle.year                                                        | null                                                                                                           |
      | vehicle.colour                                                      | null                                                                                                           |
      | vehicle.markings                                                    | null                                                                                                           |
      | party.poleId.v2.id                                                  | SNSENS:P=null[{trailer001NationalitymovementReferenceNumber}]                                                  |
      | party.type                                                          | P                                                                                                              |
      | role                                                                | PTOOLINK                                                                                                       |
  ...
  Scenario: STOP: SNS-M-TRAILER not created if modeOfTransportAtBorder either is 10 or 11
    When the background template of Sns data is changed to
      | field                                  | value |
      | body.itinerary.modeOfTransportAtBorder | 50    |
    And StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 0 Object Commands for SNS-M-TRAILER will be emitted

  Scenario: STOP: SNS-M-TRAILER not created if length identityOfMeansOfCrossingBorder.identity <= 9
    When the background template of Sns data is changed to
      | field                                                   | value    |
  ...
  Scenario: STOP: SNS-M-TRAILER not created identityOfMeansOfCrossingBorder.identity is <=1
    When the background template of Sns data is changed to
      | field                                                   | value |
      | body.itinerary.identityOfMeansOfCrossingBorder.identity | 1     |
    And StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 0 Object Commands for SNS-M-TRAILER will be emitted

  Scenario: STOP: SNS-M-TRAILER not created when trailerIsNull(custom Registration number)
    When the background template of Sns data is changed to
      | field                                                   | value  |
      | body.itinerary.identityOfMeansOfCrossingBorder.identity | t#f t# |
    And StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 0 Object Commands for SNS-M-TRAILER will be emitted


  Scenario Outline: CUSTOM: Testing Registration Number field
  # FOR OBJVEHC(itinerary.identityOfMeansOfCrossingBorder.identity), if length > 9 split on " " OR "#" take right split else if length <= 9 then STOP
    When the background template of Sns data is changed to
      | field                                                   | value            |
      | body.itinerary.identityOfMeansOfCrossingBorder.identity | <actualIdentity> |
    And StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 1 Object Commands for SNS-M-TRAILER will be emitted
    And one Object record for "SNS-M-TRAILER" with following attributes
      | metadata.identityRecord.poleId.v2.id                                | SNSENS:P=null[{<expectedIdentity>NationalitymovementReferenceNumber}],O={<expectedIdentity>NationalitymovementReferenceNumber} |
      | metadata.identityRecord.type                                        | O                                                                                                                              |
      | metadata.sourceRecord.name                                          | SNSENS                                                                                                                         |
      | metadata.sourceRecord.shortName                                     | SNS                                                                                                                            |
      | metadata.sourceRecord.location                                      | submissionIdmetadata.messageIdentification                                                                                     |
      | metadata.sourceRecord.id                                            | {<expectedIdentity>NationalitymovementReferenceNumber}                                                                         |
      | metadata.sourceRecord.audit.createdBy                               | 0123456789                                                                                                                     |
      | metadata.sourceRecord.audit.createdTimestamp                        | 2022-02-22T22:22:22.222Z                                                                                                       |
      | metadata.sourceRecord.audit.updatedBy                               | null                                                                                                                           |
      | metadata.sourceRecord.audit.updatedTimestamp                        | null                                                                                                                           |
      ...
      | vehicle.vin                                                         | null                                                                                                                           |
      | vehicle.registrationCountry                                         | Nationality                                                                                                                    |
      | vehicle.registrationNumber                                          | <expectedIdentity>                                                                                                             |
      | vehicle.year                                                        | null                                                                                                                           |
      | vehicle.colour                                                      | null                                                                                                                           |
      | vehicle.markings                                                    | null                                                                                                                           |
      | party.poleId.v2.id                                                  | SNSENS:P=null[{<expectedIdentity>NationalitymovementReferenceNumber}]                                                          |
      | party.type                                                          | P                                                                                                                              |
      | role                                                                | PTOOLINK                                                                                                                       |
      | attributes.attrs.header.ingestDateTime                              | 2022-02-22T22:22:22.222Z                                                                                                       |
      | attributes.attrs.itinerary.identityOfMeansOfCrossingBorder.language | itinerary.identityOfMeansOfCrossingBorder.language                                                                             |
    ...
    Examples:
      ...
      | Identity123 Trailer456   | Trailer456       |
      | IdentityNumber#Trailer54 | Trailer54        |

  Scenario Outline: CUSTOM: Testing Registration Number field and Trailers generated
  # FOR OBJVEHC(itinerary.identityOfMeansOfCrossingBorder.identity), if length > 9 split on " " OR "#" take right split else if length <= 9 then STOP
    When the background template of Sns data is changed to
      | field                                                   | value            |
      | body.itinerary.identityOfMeansOfCrossingBorder.identity | <actualIdentity> |
    And StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then <expectNumberOfTrailers> Object Commands for SNS-M-TRAILER will be emitted
    Examples:
      | actualIdentity                         | expectNumberOfTrailers |
      | Vehicle123                             | 0                      |
      | Vehicle1 Trailer1                      | 1                      |
      | Vehicle123 456 789 ABC EDF             | 0                      |
      | Vehicle123#Vehicle456#Vehicle789       | 1                      |
      #| VehicleNumber#54 54 543#AAA111#BCD 234 | 1                      |

# DEV NOTE - below commented due to new logic which does not currently handle these - for review in later release 2.1.5
#     | Vehicle1 Trailer1 Trailer2 Trailer3 Trailer4? | 0                      |
