@objectVehicle
Feature: SNS Command Adaptor - Object - SNS-M-VEHICLE
  ...
  Scenario: ObjectRecord - SNS-M-VEHICLE
    When StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 1 Object Commands for SNS-M-VEHICLE will be emitted
    And one Object record for "SNS-M-VEHICLE" with following attributes
      | metadata.identityRecord.poleId.v2.id                                | SNSENS:P=null[{Nationalityvehicle001}],O={Nationalityvehicle001} |
      ...
      | metadata.sourceRecord.id                                            | {Nationalityvehicle001}                                          |
      ...
      | party.poleId.v2.id                                                  | SNSENS:P=null[{Nationalityvehicle001}]                           |
      | party.type                                                          | P                                                                |
      | role                                                                | PTOOLINK                                                         |
  ...
  Scenario: STOP: SNS-M-VEHICLE not created if modeOfTransportAtBorder=1
    ...
    Then 0 Object Commands for SNS-M-VEHICLE will be emitted

  Scenario: STOP: SNS-M-VEHICLE not created if STOP: SNS-C-VEHICLE not created if vehicleSplit returns null due to invalid value in body.itinerary.identityOfMeansOfCrossingBorder.identity
    When the background template of Sns data is changed to
      | field                                                   | value             |
      | body.itinerary.identityOfMeansOfCrossingBorder.identity | VehicleTrailer    |
    And StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 0 Object Commands for SNS-M-VEHICLE will be emitted

  Scenario Outline: CUSTOM: Testing Registration Number field
  # FOR OBJVEHC(itinerary.identityOfMeansOfCrossingBorder.identity), if length > 9, split field on " " or "#" take left split else use full field
    When the background template of Sns data is changed to
      | field                                                   | value            |
      | body.itinerary.identityOfMeansOfCrossingBorder.identity | <actualIdentity> |
    And StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then <expectNumberOfVehicle> Object Commands for SNS-M-VEHICLE will be emitted
    And one Object record for "SNS-M-VEHICLE" with following attributes
      | metadata.identityRecord.poleId.v2.id                                | SNSENS:P=null[{Nationality<expectedIdentity>}],O={Nationality<expectedIdentity>} |
      | metadata.identityRecord.type                                        | O                                                                                |
      | metadata.sourceRecord.name                                          | SNSENS                                                                           |
      | metadata.sourceRecord.shortName                                     | SNS                                                                              |
      | metadata.sourceRecord.location                                      | submissionIdmetadata.messageIdentification                                       |
      | metadata.sourceRecord.id                                            | {Nationality<expectedIdentity>}                                                  |
      | metadata.sourceRecord.audit.createdBy                               | 0123456789                                                                       |
      | metadata.sourceRecord.audit.createdTimestamp                        | 2022-02-22T22:22:22.222Z                                                         |
      | metadata.sourceRecord.audit.updatedBy                               | null                                                                             |
      | metadata.sourceRecord.audit.updatedTimestamp                        | null                                                                             |
      ...
      | vehicle.colour                                                      | null                                                                             |
      | vehicle.markings                                                    | null                                                                             |
      | party.poleId.v2.id                                                  | SNSENS:P=null[{Nationality<expectedIdentity>}]                                   |
      | party.type                                                          | P                                                                                |
      | role                                                                | PTOOLINK                                                                         |
      | attributes.attrs.header.ingestDateTime                              | 2022-02-22T22:22:22.222Z                                                         |
      | attributes.attrs.itinerary.identityOfMeansOfCrossingBorder.language | itinerary.identityOfMeansOfCrossingBorder.language                               |
    ...
    Examples:
      | actualIdentity  | expectedIdentity | expectNumberOfVehicle |
      | Identity123 456 | Identity123      | 1                     |
      | Identity123:456 | Identity123      | 1                     |

# DEV NOTE - below commented due to new logic which does not currently handle these - for review in later release 2.1.5
#      | IdentityNumber#54  | IdentityNumber    | 1                     |
#      | IdentityNumber.234 | IdentityNumber234 | 1                     |
