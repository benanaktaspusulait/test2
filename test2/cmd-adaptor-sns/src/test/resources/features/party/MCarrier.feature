@OrganisationSnsCarrier
Feature: Test sns Command Adaptor - Party - Organisation - SNS-M-CARRIER
  ...
  Background:
    Given template StreamIngestRecord source data with the following attributes
      ...
      | body.parties.carrier.name                                             | carrierName                                                      |
      | body.parties.carrier.address.streetAndNumber                          | streetAndNumber                                                  |
      | body.parties.carrier.address.city                                     | city                                                             |
      | body.parties.carrier.address.postalCode                               | postalCode                                                       |
      | body.parties.carrier.address.countryCode                              | countryCode                                                      |
      | body.parties.carrier.language                                         | parties.carrier.language                                         |
      | body.parties.carrier.eori                                             | null                                                             |
  ...
  Scenario: PartyRecord - Organisation - SNS-M-CARRIER
    When StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 1 Party Commands for SNS-M-CARRIER will be emitted
    And one Party record for "SNS-M-CARRIER" with following attributes
      | metadata.identityRecord.poleId.v2.id          | SNSENS:P={carrierNamestreetAndNumbercitypostalCodecountryCode}[SNS-M-CARRIER] |
      ...
      | metadata.sourceRecord.id                      | {carrierNamestreetAndNumbercitypostalCodecountryCode}                         |
  ...
  Scenario: PartyRecord - Organisation - SNS-M-CARRIER
    ...
    And one Party record for "SNS-M-CARRIER" with following attributes
      ...
      | attributes.attrs.header.ingestDateTime         | 2022-02-22T22:22:22.222Z                   |
      | attributes.attrs.parties.carrier.language      | parties.carrier.language                   |
      | attributes.attrs.parties.carrier.eori          | EORI56                                     |
  ...
  Scenario: STOP: SNS-M-CARRIER not created if name and eori are null
    When the background template of Sns data is changed to
      | field                     | value |
      | body.parties.carrier.name | null  |
      | body.parties.carrier.eori | null  |
    And StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 0 Party Commands for SNS-M-CARRIER will be emitted
