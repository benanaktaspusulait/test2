@OrganisationSnsMNotify
Feature: Test sns Command Adaptor - Party - Organisation - SNS-M-NOTIFY
  ...
  Scenario: PartyRecord - Organisation - SNS-M-NOTIFY
    When StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 1 Party Commands for SNS-M-NOTIFY will be emitted
    And one Party record for "SNS-M-NOTIFY" with following attributes
      | metadata.identityRecord.poleId.v2.id          | SNSENS:P={partiesNotifyName56BristolBR00 6OL100}[SNS-M-NOTIFY] |
      ...
      | metadata.sourceRecord.id                      | {partiesNotifyName56BristolBR00 6OL100}                        |
      ...
      | organisation.name                             | partiesNotifyName                                              |
  ...
  Scenario: SNS-M-NOTIFY is created if name and eori is not null
    ...
    And one Party record for "SNS-M-NOTIFY" with following attributes
      ...
      | attributes.attrs.header.ingestDateTime         | 2022-02-22T22:22:22.222Z                   |
      | attributes.attrs.parties.notifyParty.language  | parties.notifyParty.language               |
      | attributes.attrs.parties.notifyParty.eori      | EORI56                                     |
  ...
  Scenario: STOP: SNS-M-NOTIFY not created if name and eori are null
    When the background template of Sns data is changed to
      | field                         | value |
      | body.parties.notifyParty.name | null  |
      | body.parties.notifyParty.eori | null  |
    And StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 0 Party Commands for SNS-M-NOTIFY will be emitted
