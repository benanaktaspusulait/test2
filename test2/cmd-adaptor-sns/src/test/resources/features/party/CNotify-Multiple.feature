@OrganisationSnsCNotifyMultiple
Feature: Test sns Command Adaptor - Party - Organisation - SNS-C-NOTIFY multiple
  ...
  Scenario: PartyRecord - Organisation - SNS-C-NOTIFY multiple
    When StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 2 Party Commands for SNS-C-NOTIFY will be emitted
    And one Party record for "SNS-C-NOTIFY" with following attributes
      | metadata.identityRecord.poleId.v2.id                   | SNSENS:P={notifyPartyName100ReadingRG1 0NG100}[SNS-C-NOTIFY] |
      ...
      | metadata.sourceRecord.id                               | {notifyPartyName100ReadingRG1 0NG100}                        |
      ...
      | organisation.name                                      | notifyPartyName                                              |
    ...
    And one Party record for "SNS-C-NOTIFY" with following attributes
      | metadata.identityRecord.poleId.v2.id                   | SNSENS:P={notifyPartyName166LiverpoolLI90 POL100}[SNS-C-NOTIFY] |
      | metadata.identityRecord.type                           | P                                                               |
      | metadata.sourceRecord.name                             | SNSENS                                                          |
      | metadata.sourceRecord.shortName                        | SNS                                                             |
      | metadata.sourceRecord.location                         | submissionIdmetadata.messageIdentification                      |
      | metadata.sourceRecord.id                               | {notifyPartyName166LiverpoolLI90 POL100}                        |
      | metadata.sourceRecord.audit.createdBy                  | 0123456789                                                      |
      | metadata.sourceRecord.audit.createdTimestamp           | 2022-02-22T22:22:22.222Z                                        |
      | metadata.mappingRecord.name                            | SNS-C-NOTIFY                                                    |
      | metadata.mappingRecord.version                         | mappingVersion                                                  |
      ...
      | type                                                   | ORGANISATION                                                    |
      | organisation.type                                      | ORGNOTIFY                                                       |
      | organisation.name                                      | notifyPartyName1                                                |
      | organisation.registrationNumber                        | null                                                            |
      | organisation.vatNumber                                 | null                                                            |
      | organisation.industrySector                            | null                                                            |
      | organisation.numberOfEmployees                         | null                                                            |
  ...
  Scenario: SNS-C-NOTIFY is created if EORI is not null
    When the background template of Sns data is changed to
      | field                                    | value  |
      | body.goods.goodsItems.0.notifyParty.eori | EORI56 |
      | body.goods.goodsItems.1.notifyParty.eori | EORI57 |
    And StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 2 Party Commands for SNS-C-NOTIFY will be emitted
    And one Party record for "SNS-C-NOTIFY" with following attributes
      | metadata.identityRecord.poleId.v2.id                   | SNSENS:P={EORI56}[SNS-C-NOTIFY]            |
      | metadata.identityRecord.type                           | P                                          |
      | metadata.sourceRecord.name                             | SNSENS                                     |
      | metadata.sourceRecord.shortName                        | SNS                                        |
      | metadata.sourceRecord.location                         | submissionIdmetadata.messageIdentification |
      ...
      | attributes.attrs.header.ingestDateTime                 | 2022-02-22T22:22:22.222Z                   |
      | attributes.attrs.goods.goodsItems.notifyParty.language | goods.goodsItems.0.notifyParty.language    |
      | attributes.attrs.goods.goodsItems.notifyParty.eori     | EORI56                                     |
    ...
    And one Party record for "SNS-C-NOTIFY" with following attributes
      | metadata.identityRecord.poleId.v2.id                   | SNSENS:P={EORI57}[SNS-C-NOTIFY]            |
      | metadata.identityRecord.type                           | P                                          |
      | metadata.sourceRecord.name                             | SNSENS                                     |
      | metadata.sourceRecord.shortName                        | SNS                                        |
      | metadata.sourceRecord.location                         | submissionIdmetadata.messageIdentification |
      ...
      | attributes.attrs.header.ingestDateTime                 | 2022-02-22T22:22:22.222Z                   |
      | attributes.attrs.goods.goodsItems.notifyParty.language | goods.goodsItems.1.notifyParty.language    |
      | attributes.attrs.goods.goodsItems.notifyParty.eori     | EORI57                                     |
  ...
  Scenario: STOP: SNS-C-NOTIFY not created if name and eori are null
    When the background template of Sns data is changed to
      | field                                    | value |
      | body.goods.goodsItems.0.notifyParty.name | null  |
      | body.goods.goodsItems.0.notifyParty.eori | null  |
      | body.goods.goodsItems.1.notifyParty.name | null  |
      | body.goods.goodsItems.1.notifyParty.eori | null  |
    And StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 0 Party Commands for SNS-C-NOTIFY will be emitted
