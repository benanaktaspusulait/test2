@OrganisationSnsMConsignee
Feature: Test sns Command Adaptor - Party - Organisation - SNS-M-CONSIGNEE
  ...
  Scenario: PartyRecord - Organisation - SNS-M-CONSIGNEE
    When StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 1 Party Commands for SNS-M-CONSIGNEE will be emitted
    And one Party record for "SNS-M-CONSIGNEE" with following attributes
      | metadata.identityRecord.poleId.v2.id          | SNSENS:P={partiesConsigneeName23ParisPA12 IS200}[SNS-M-CONSIGNEE] |
      ...
      | metadata.sourceRecord.id                      | {partiesConsigneeName23ParisPA12 IS200}                           |
      ...
      | organisation.name                             | partiesConsigneeName                                              |
  ...
  Scenario: SNS-M-CONSIGNEE is created if EORI is not null
    ...
    And one Party record for "SNS-M-CONSIGNEE" with following attributes
      ...
      | attributes.attrs.header.ingestDateTime         | 2022-02-22T22:22:22.222Z                   |
      | attributes.attrs.parties.consignee.language    | parties.consignee.language                 |
      | attributes.attrs.parties.consignee.eori        | EORI56                                     |
  ...
  Scenario: STOP: SNS-M-CONSIGNEE not created if name and eori are null
    When the background template of Sns data is changed to
      | field                       | value |
      | body.parties.consignee.name | null  |
      | body.parties.consignee.eori | null  |
    And StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 0 Party Commands for SNS-M-CONSIGNEE will be emitted