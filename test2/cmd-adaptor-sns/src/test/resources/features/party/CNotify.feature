@OrganisationSnsCNotify
Feature: Test sns Command Adaptor - Party - Organisation - SNS-C-NOTIFY
  ...
  Scenario: SNS-C-NOTIFY is created if EORI is not null
    When the background template of Sns data is changed to
      | field                                    | value  |
      | body.goods.goodsItems.0.notifyParty.eori | EORI57 |
