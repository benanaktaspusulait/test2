@EventSnsTra2Cons
Feature: Test sns Command Adaptor - Event - Association Start - SNS-ASSOC-Tra2Cons
  ...
  Scenario: EventRecord - AssociationStart - SNS-ASSOC-Tra2Cons
    When StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 1 Event Commands for SNS-ASSOC-Tra2Cons will be emitted
    And one Event record for "SNS-ASSOC-Tra2Cons" with following attributes
      | metadata.identityRecord.poleId.v2.id          | SNSENS:E={[SNSENS:P=null[{trailer001NationalitymovementReferenceNumber}],O={trailer001NationalitymovementReferenceNumber}][SNSENS:S={movementReferenceNumber123}][OTOSASSO]} |
      ...
      | metadata.sourceRecord.id                      | {[SNSENS:P=null[{trailer001NationalitymovementReferenceNumber}],O={trailer001NationalitymovementReferenceNumber}][SNSENS:S={movementReferenceNumber123}][OTOSASSO]}          |
      ...
      | subject.poleId.v2.id                          | SNSENS:P=null[{trailer001NationalitymovementReferenceNumber}],O={trailer001NationalitymovementReferenceNumber}                                                               |
      | subject.type                                  | O                                                                                                                            |
  ...
  Scenario: EventRecord - AssociationStart - SNS-ASSOC-Tra2Cons. Empty trailer
    When the background template of Sns data is changed to
      | field                                                   | value  |
      | body.itinerary.identityOfMeansOfCrossingBorder.identity | AAA111 |
    And StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 0 Event Commands for SNS-ASSOC-Tra2Cons will be emitted

#  DEV Note - Commented-out below due to this returning null when multiple space input
# This is because new function for multiple space includes SPACES in trailer which final regex filter in custom will not pass
#  Scenario: EventRecord - AssociationStart - SNS-ASSOC-Tra2Cons
#    When the background template of Sns data is changed to
#      | field                                                   | value                       |
#      | body.itinerary.identityOfMeansOfCrossingBorder.identity | AAA111 BBB222 CCC333 DD4444|
#    And StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
#    Then 3 Event Commands for SNS-ASSOC-Tra2Cons will be emitted


#  DEV Note - Commented-out below due to missing custom in mapping
#  Scenario: STOP: SNS-ASSOC-Tra2Cons not created if identity is less that 10 characters long
#    When the background template of Sns data is changed to
#      | field                                                   | value  |
...
#    Then 0 Event Commands for SNS-ASSOC-Tra2Cons will be emitted
  ...
  Scenario: STOP: SNS-ASSOC-Tra2Cons not created if modeOfTransportAtBorder is equal to "1"
    When the background template of Sns data is changed to
      | field                                  | value |
  ...
  Scenario: STOP: SNS-ASSOC-Tra2Cons not created identityOfMeansOfCrossingBorder.identity is <=1
    When the background template of Sns data is changed to
      | field                                                   | value |
