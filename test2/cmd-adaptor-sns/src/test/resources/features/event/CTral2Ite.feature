@EventSnsCTral2Ite
Feature: Test sns Command Adaptor - Event - Association Start - SNS-ASSOC-CTral2Ite
  ...
  Scenario Outline: EventRecord - AssociationStart - SNS-ASSOC-CTral2Ite
    ...
    Then 1 Event Commands for SNS-ASSOC-CTral2Ite will be emitted
    And one Event record for "SNS-ASSOC-CTral2Ite" with following attributes
      | metadata.identityRecord.poleId.v2.id          | SNSENS:E={[SNSENS:P=null[{trailer001NationalitymovementReferenceNumber}],O={trailer001NationalitymovementReferenceNumber}][SNSENS:S={movementReferenceNumberIN1234}][OTOSASSO]} |
      ...
      | metadata.sourceRecord.id                      | {[SNSENS:P=null[{trailer001NationalitymovementReferenceNumber}],O={trailer001NationalitymovementReferenceNumber}][SNSENS:S={movementReferenceNumberIN1234}][OTOSASSO]}          |
  ...
  Scenario Outline: STOP: SNS-ASSOC-CTral2Ite not created if identity or mode is not 2,3,10,11
    When the background template of Sns data is changed to
      | field                                                              | value      |
    ...
    Then 0 Event Commands for SNS-ASSOC-CTral2Ite will be emitted
    Examples:
      | identity              | mode |
      | [blank]               | 2    |
      | null                  | 2    |
