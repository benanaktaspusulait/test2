@EventSnsCCon2Ite
Feature: Test sns Command Adaptor - Event - Association Start - SNS-ASSOC-CCon2Cons
  ...
  Scenario: STOP: SNS-ASSOC-CCon2Cons not created if name and eori are null
