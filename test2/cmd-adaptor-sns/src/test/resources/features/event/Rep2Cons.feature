@EventSnsRep2Cons
Feature: Test sns Command Adaptor - Event - Association Start - SNS-ASSOC-Rep2Cons
  ...
  Scenario: EventRecord - AssociationStart - SNS-ASSOC-Rep2Cons
    When StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 1 Event Commands for SNS-ASSOC-Rep2Cons will be emitted
    And one Event record for "SNS-ASSOC-Rep2Cons" with following attributes
      | metadata.identityRecord.poleId.v2.id          | SNSENS:E={[SNSENS:P={representativeName33LondonLN12 7ON100}[SNS-REPRESENTATIVE]][SNSENS:S={movementReferenceNumber123}][PTOS]} |
      ...
      | metadata.sourceRecord.id                      | {[SNSENS:P={representativeName33LondonLN12 7ON100}[SNS-REPRESENTATIVE]][SNSENS:S={movementReferenceNumber123}][PTOS]}          |
      ...
      | subject.poleId.v2.id                          | SNSENS:P={representativeName33LondonLN12 7ON100}[SNS-REPRESENTATIVE]                                                           |
      | subject.type                                  | P                                                                                                                              |
  ...
  Scenario: STOP: SNS-ASSOC-Rep2Cons not created if name and eori are null
    ...
    Then 0 Event Commands for SNS-ASSOC-Rep2Cons will be emitted
