@EventSnsCVes2Ite
Feature: Test sns Command Adaptor - Event - Association Start - SNS-ASSOC-CVes2Ite
  ...
  Scenario Outline: EventRecord - AssociationStart - SNS-ASSOC-CVes2Ite
    ...
    Then 1 Event Commands for SNS-ASSOC-CVes2Ite will be emitted
    And one Event record for "SNS-ASSOC-CVes2Ite" with following attributes
      | metadata.identityRecord.poleId.v2.id          | SNSENS:E={[SNSENS:P=null[{IMO1234567Nationality}],O={IMO1234567Nationality}][SNSENS:S={movementReferenceNumberIN1234}][OTOSASSO]} |
      ...
      | metadata.sourceRecord.id                      | {[SNSENS:P=null[{IMO1234567Nationality}],O={IMO1234567Nationality}][SNSENS:S={movementReferenceNumberIN1234}][OTOSASSO]}          |
      ...
      | subject.poleId.v2.id                          | SNSENS:P=null[{IMO1234567Nationality}],O={IMO1234567Nationality}                                                                  |
      | subject.type                                  | O                                                                                                                                 |
  ...
  Scenario Outline: STOP: SNS-ASSOC-CVes2Ite not created if identity or mode is not 2,3,10,11
    When the background template of Sns data is changed to
      | field                                                              | value      |
      | body.goods.goodsItems.0.identityOfMeansOfCrossingBorder.0.identity | <identity> |
      | body.itinerary.modeOfTransportAtBorder                             | <mode>     |
    And StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 0 Event Commands for SNS-ASSOC-CVes2Ite will be emitted
    Examples:
      | identity        | mode |
      | [blank]         | 1    |
      | null            | 1    |
