@EventSnsMCar2Cons
Feature: Test sns Command Adaptor - Event - Association Start - SNS-ASSOC-MCar2Cons
  ...
  Background:
    Given template StreamIngestRecord source data with the following attributes
      ...
      | body.parties.carrier.name                                             | Bob                                                              |
      | body.parties.carrier.address.streetAndNumber                          | Farm close                                                       |
      | body.parties.carrier.address.city                                     | London                                                           |
      | body.parties.carrier.address.postalCode                               | Ha5 1hy                                                          |
      | body.parties.carrier.address.countryCode                              | 100                                                              |
  ...
  Scenario: EventRecord - AssociationStart - SNS-ASSOC-MCar2Cons
    When StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 1 Event Commands for SNS-ASSOC-MCar2Cons will be emitted
    And one Event record for "SNS-ASSOC-MCar2Cons" with following attributes
      | metadata.identityRecord.poleId.v2.id          | SNSENS:E={[SNSENS:P={BobFarm closeLondonHa5 1hy100}[SNS-M-CARRIER]][SNSENS:S={movementReferenceNumber123}][PTOS]} |
      ...
      | metadata.sourceRecord.id                      | {[SNSENS:P={BobFarm closeLondonHa5 1hy100}[SNS-M-CARRIER]][SNSENS:S={movementReferenceNumber123}][PTOS]}          |
      ...
      | subject.poleId.v2.id                          | SNSENS:P={BobFarm closeLondonHa5 1hy100}[SNS-M-CARRIER]                                                           |
      | subject.type                                  | P                                                                                                                 |
  ...
  Scenario: STOP: SNS-ASSOC-MCar2Cons not created if name and eori are null
    ...
    Then 0 Event Commands for SNS-ASSOC-MCar2Cons will be emitted
