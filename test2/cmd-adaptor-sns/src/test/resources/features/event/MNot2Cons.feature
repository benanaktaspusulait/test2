@EventSnsMNot2Cons
Feature: Test sns Command Adaptor - Event - Association Start - SNS-ASSOC-MNot2Cons
  ...
  Scenario: EventRecord - AssociationStart - SNS-ASSOC-MNot2Cons
    When StreamIngestRecord source data is presented with attributes as per the template to the fdp-sns-input_0 input topic
    Then 1 Event Commands for SNS-ASSOC-MNot2Cons will be emitted
    And one Event record for "SNS-ASSOC-MNot2Cons" with following attributes
      | metadata.identityRecord.poleId.v2.id          | SNSENS:E={[SNSENS:P={partiesNotifyName56BristolBR00 6OL100}[SNS-M-NOTIFY]][SNSENS:S={movementReferenceNumber123}][PTOS]} |
      ...
      | metadata.sourceRecord.id                      | {[SNSENS:P={partiesNotifyName56BristolBR00 6OL100}[SNS-M-NOTIFY]][SNSENS:S={movementReferenceNumber123}][PTOS]}          |
      ...
      | subject.poleId.v2.id                          | SNSENS:P={partiesNotifyName56BristolBR00 6OL100}[SNS-M-NOTIFY]                                                           |
      | subject.type                                  | P                                                                                                                        |
  ...
  Scenario: STOP: SNS-ASSOC-MNot2Cons not created if name and eori are null
    ...
    Then 0 Event Commands for SNS-ASSOC-MNot2Cons will be emitted
